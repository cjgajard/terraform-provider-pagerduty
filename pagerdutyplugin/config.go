...
func (c *Config) Client(ctx context.Context) (*pagerduty.Client, error) {
	...
	client, err := c.getClient(ctx, apiURL, c.Token, clientOpts)
	if err != nil {
		return nil, err
	}
...
func (c *Config) SlackClient(ctx context.Context) (*pagerduty.Client, error) {
	...
	slackClient, err := c.getClient(ctx, c.AppURL, c.UserToken, []pagerduty.ClientOptions{})
	if err != nil {
		return nil, err
	}
...
func (c *Config) getClient(ctx context.Context, url, token string, opts []pagerduty.ClientOptions) (*pagerduty.Client, error) {
